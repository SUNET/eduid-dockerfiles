...
python ./setup.py develop --index-url https://pypi.sunet.se/simple --allow-hosts *.sunet.se,*.python.org,*.github.com,*.launchpad.net,*.cherrypy.org,*.sf.net,*.sourceforge.net
