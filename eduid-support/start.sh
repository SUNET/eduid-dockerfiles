...
eduid_name=${eduid_name-'support'}
app_name=${app_name-'support'}
...
gunicorn_args="--bind 0.0.0.0:8080 -w ${workers} -k ${worker_class} --threads ${worker_threads} -t ${worker_timeout} eduid_webapp.support.run:app"
